...
# 1) Configuration
# ----------------------------------------------------------------------------------
DATASET_FILE                = "pubchem/train_50k.csv"
EVAL_FILE                   = "pubchem/eval_100.csv"
MODEL_NAME                  = "Qwen/Qwen2-VL-2B-Instruct"
OUTPUT_DIR                  = "Qwen2-VL-2B-SFT-Instruct-Full"
...
training_args = SFTConfig(
    ...
    deepspeed_config = "./deepspeed_config_zero2.json" if USE_DEEPSPEED else None,
    bf16=True,
    save_total_limit=1,
...
if __name__ == "__main__":
    ...
    trainer.train(resume_from_checkpoint="Qwen2-VL-2B-SFT-Instruct-Full/checkpoint-7145")
